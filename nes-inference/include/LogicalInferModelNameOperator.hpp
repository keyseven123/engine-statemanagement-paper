...
public:
    ...
    [[nodiscard]] std::string_view getName() const noexcept override { return "INFER_MODEL_NAME"; }
    [[nodiscard]] SerializableOperator serialize() const override
    {
        SerializableLogicalOperator proto;

        proto.set_operator_type("INFER_MODEL_NAME");
        ...
        for (const auto& inputSchema : getInputSchemas())
        {
            ...
            SchemaSerializationUtil::serializeSchema(Schema{}, schProto);
        }
